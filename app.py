...
class ProductChatbot:
    ...
    def build_context(self) -> str:
        """
        প্রতিটা শীটকে (ক্যাটাগরি হিসেবে ধরে নিয়ে) আলাদা করে লিস্ট করা হয়,
        যাতে AI বুঝতে পারে কোন প্রোডাক্ট কোন গ্রুপের। Excel এ যেই কলাম
        নামই থাকুক না কেন (Product Name/পণ্যের নাম/Item ইত্যাদি যেকোনো
        ভাষায় বা নামে), কলামের নাম হার্ডকোড না করে পুরো row-টাকেই
        'কলাম-নাম: ভ্যালু' আকারে টেক্সট বানানো হয়। AI নিজেই বুঝে নেয়
        কোনটা দাম, কোনটা স্টক, কোনটা বিবরণ ইত্যাদি।
        """
        all_lines = []
        product_no = 1
        for sheet_name, df in self.df.items():
            all_lines.append(f"\n=== শীট/ক্যাটাগরি: {sheet_name} ===")
            ...
            for _, row in df.iterrows():
                ...
                all_lines.append(f"[Product {product_no}] " + " | ".join(parts))
                product_no += 1
        return "\n".join(all_lines)
