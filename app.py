...
class ProductChatbot:
    ...
    def build_context(self) -> str:
        """সব প্রোডাক্টের তথ্য একটা টেক্সট ব্লকে সাজানো হচ্ছে, যেটা AI কে দেওয়া হবে"""
        lines = []
        for _, row in self.df.iterrows():
            ...
            lines.append(
                f"- Product Name: {name} | Category: {category} | "
                f"Price: {price} Taka | Stock: {stock} pieces | "
                f"Description: {desc}"
            )
        return "\n".join(lines)
...
3. কাস্টমার যদি শুধু দাম জানতে চায়, শুধু দাম বলবে। স্টক জানতে চাইলে
   শুধু স্টক বলবে। পুরো তথ্য চাইলে (বা বোঝা না গেলে) সব তথ্য সুন্দর করে
   গুছিয়ে দেবে।
4. প্রশ্নের সাথে মিলে এমন প্রোডাক্ট লিস্টে না থাকলে, ভদ্রভাবে বলবে যে
   পাওয়া যায়নি এবং লিস্টে থাকা কয়েকটা প্রোডাক্টের নাম উদাহরণ হিসেবে
   বলবে।
5. উত্তর সংক্ষিপ্ত, স্পষ্ট ও বন্ধুত্বপূর্ণ রাখবে। ইমোজি ব্যবহার করতে
   পারো (📦 💰 ✅ ❌)।
6. একাধিক প্রোডাক্ট প্রশ্নের সাথে মিলে গেলে (যেমন ক্যাটাগরি জিজ্ঞেস করলে),
