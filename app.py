...
from logger_gsheets import log_chat_async
...
def chat():
    ...
    # কাস্টমারের প্রশ্ন ও bot এর উত্তর Google Sheet এ লগ করা (ব্যাকগ্রাউন্ডে,
    # তাই কাস্টমারের রেসপন্স স্পিড কমবে না)
    user_ip = request.headers.get("X-Forwarded-For", request.remote_addr)
    log_chat_async(question=user_msg, answer=reply, user_ip=user_ip)
